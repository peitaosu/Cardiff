...
class Cardiff():
    ...
    def cmd_diff(self, file_ver):
        ...
        visualize_diff(os.path.join(self.temp, new_file_1), file_diffs, os.path.join(self.temp, new_file_2), file_path.split(".")[-1], os.path.join(self.temp, file_path.split(".")[0] + "_" + ver_1[:6] + "_" + ver_2[:6]))
