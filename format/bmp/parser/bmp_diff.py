...
class BMP_DIFF():
    def __init__(self):
        self.attributes = ["bfSize", "biSize", "biWidth", "biHeight", "biBitCount", "biCompression",
                           "biSizeImage", "biXPelsPerMeter", "biYPelsPerMeter", "biClrUsed", "biClrImportant"]
        self.description = ["The size of the file in bytes", "Header Size", "Image width in pixels", "Image height in pixels", "Bits per pixel", "Compression typ", "Image Size",
